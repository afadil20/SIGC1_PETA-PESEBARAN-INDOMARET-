...
map.getView().fit([12536643.241968, -887148.606331, 12540328.232170, -885296.689113], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Pesebaran Indomaret</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (136 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'peta ini menyajikan informasi geografis line batas daerah, kecamatan,fasilitas umum, lahan terbuka, pemukiman, jalan gang, jalan utama  ';
            }
